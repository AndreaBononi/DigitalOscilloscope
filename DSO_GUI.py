...
# FUNZIONE DI DISEGNO DEL GRAFICO ------------------------------------------------------------------------------------------------------
def drawGraph():
	global yCH0
	global yCH1
...
# FUNZIONE DI AGGIORNAMENTO TRIGGER LEVEL ----------------------------------------------------------------------------------------------
def updateTL():
	global TL
	global serialCom
	error = False
...
# FUNZIONE DI AGGIORNAMENTO TRIGGER POSITION ------------------------------------------------------------------------------------------
def updateTP():
	global TP
	error = False
	try:
...
# FUNZIONE DI AGGIORNAMENTO TIME INTERVAL ---------------------------------------------------------------------------------------------
def updateTI():
	global TI
	global lastTimeUnit
	error = False
...
# FUNZIONE DI AGGIORNAMENTO TRIGGER TYPE ----------------------------------------------------------------------------------------------
def updateTT():
	global TT
